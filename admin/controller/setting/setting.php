	...
	public function index() {
		...
		if (isset($this->request->post['config_email'])) {
			...
			$this->data['config_email'] = $this->config->get('config_email');
				...
				if (isset($this->request->post['config_telephoneprefix'])) {
			$this->data['config_telephoneprefix'] = $this->request->post['config_telephoneprefix'];
		} else {
			$this->data['config_telephoneprefix'] = $this->config->get('config_telephoneprefix');
		}
