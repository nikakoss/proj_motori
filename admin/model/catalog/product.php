...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "product SET model = '" . $this->db->escape($data['model']) . "', sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', ean = '" . $this->db->escape($data['ean']) . "', jan = '" . $this->db->escape($data['jan']) . "', isbn = '" . $this->db->escape($data['isbn']) . "', mpn = '" . $this->db->escape($data['mpn']) . "', location = '" . $this->db->escape($data['location']) . "',waranty = '" . $this->db->escape($data['waranty']) . "',videolink = '" . $this->db->escape($data['videolink']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', points = '" . (int)$data['points'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', tax_class_id = '" . $this->db->escape($data['tax_class_id']) . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW()");
		...
		if (isset($data['product_related'])) {
			foreach ($data['product_related'] as $related_id) {
				...
				if (isset($data['product_soput'])) {
			foreach ($data['product_soput'] as $soput_id) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_soput WHERE product_id = '" . (int)$product_id . "' AND soput_id = '" . (int)$soput_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_soput SET product_id = '" . (int)$product_id . "', soput_id = '" . (int)$soput_id . "'");
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_soput WHERE product_id = '" . (int)$soput_id . "' AND soput_id = '" . (int)$product_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_soput SET product_id = '" . (int)$soput_id . "', soput_id = '" . (int)$product_id . "'");
			}
		}
	...
	public function editProduct($product_id, $data) {
		...
		if (isset($data['product_related'])) {
			foreach ($data['product_related'] as $related_id) {
	 		...
	 		$this->db->query("DELETE FROM " . DB_PREFIX . "product_soput WHERE product_id = '" . (int)$product_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_soput WHERE soput_id = '" . (int)$product_id . "'");
	...
	public function copyProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			$data = array_merge($data, array('product_soput' => $this->getProductSoput($product_id)));
	...
	public function getProductRelated($product_id) {
		...
		public function getProductSoput($product_id) {
		$product_soput_data = array();
		
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_soput WHERE product_id = '" . (int)$product_id . "'");
		
		foreach ($query->rows as $result) {
			$product_soput_data[] = $result['soput_id'];
		}
		
		return $product_soput_data;
	}
