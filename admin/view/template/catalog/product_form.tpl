          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="location" value="<?php echo $location; ?>" /></td>
			   ...
			   <tr>
              <td>Гарантия</td>
              <td><select name="waranty">
                  <option value="0" >нет</option>
				  <option value="1" <?php if ($waranty ==1) { ?>selected="selected"<?php } ?> >1 год</option>
				  <option value="2" <?php if ($waranty ==2) { ?>selected="selected"<?php } ?> >2 года</option>
				  <option value="3" <?php if ($waranty ==3) { ?>selected="selected"<?php } ?> >3 года</option>
				 </select>
				  </td>
            </tr>
						   <tr>
              <td>Видео</td>
              <td><input type="text" style="width:200px" name="videolink" value="<?php echo $videolink; ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><div id="product-related" class="scrollbox">
                  ...
                  <?php } ?>
			            ...
			            <tr>
              <td>Рекомендуем :<br /><span class="help">(Автодополнение)</span></td>
              <td><input type="text" name="soput" value="" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><div id="product-soput" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($product_soput as $product_soput) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-soput<?php echo $product_soput['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_soput['name']; ?><img src="view/image/delete.png" alt="" />
                    <input type="hidden" name="product_soput[]" value="<?php echo $product_soput['product_id']; ?>" />
                  </div>
                  <?php } ?>
                </div></td>
            </tr>
...
$('input[name=\'soput\']').autocomplete({
	...
	select: function(event, ui) {
		$('#product-soput' + ui.item.value).remove();
		
		$('#product-soput').append('<div id="product-soput' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="product_soput[]" value="' + ui.item.value + '" /></div>');

		$('#product-soput div:odd').attr('class', 'odd');
		$('#product-soput div:even').attr('class', 'even');
...
$('#product-soput div img').live('click', function() {
	$(this).parent().remove();
