			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<table class="list" style="width: 590px;">
					...
					<tr>
						...
						<td>
							<?php echo $text_template; ?>&nbsp;<input type="text" name="seogen[informations_template]" value="<?php echo $seogen['informations_template']; ?>"><br/>
							<?php echo $text_available_tags . ' ' . $text_informations_tags; ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<?php echo $text_template; ?>&nbsp;<input type="text" name="seogen[informations_h1_template]" value="<?php echo $seogen['informations_h1_template']; ?>"><br/>
							<?php echo $text_available_tags . ' ' . $text_informations_h1_tags; ?>
						</td>
					</tr>
						<?php } ?>
					...
					<tr>
						...
						<td>
							<?php echo $text_template; ?>&nbsp;<input type="text" name="seogen[informations_title_template]"
																	  value="<?php echo $seogen['informations_title_template']; ?>"><br/>
							<?php echo $text_available_tags . ' ' . $text_informations_title_tags; ?>
						</td>
					</tr>
						<?php } ?>
					...
					<tr>
						...
						<td>
							<?php echo $text_template; ?>&nbsp;<input type="text" name="seogen[informations_meta_keyword_template]"
																	  value="<?php echo $seogen['informations_meta_keyword_template']; ?>"><br/>
							<?php echo $text_available_tags . ' ' . $text_informations_meta_keyword_tags; ?>
						</td>
					</tr>
						<?php } ?>
					...
					<tr>
						...
						<td>
							<?php echo $text_template; ?>&nbsp;<input type="text" name="seogen[informations_meta_description_template]"
																	  value="<?php echo $seogen['informations_meta_description_template']; ?>"><br/>
							<?php echo $text_available_tags . ' ' . $text_informations_meta_description_tags; ?>
						</td>
					</tr>
						<?php } ?>
					<tr>
						<td colspan="2"><a onclick="generate('informations');" class="button"><?php echo $text_generate; ?></a></td>
					</tr>
					</tbody>
				</table>
			</form>
