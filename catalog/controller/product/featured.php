...
class ControllerProductFeatured extends Controller {
	public function index() { 
		...
		$data = array(
			'prods' => $this->config->get('featured_product'),
			'sort'  => $sort,
			'order' => $order,
			'start' => ($page - 1) * $limit,
			'limit' => $limit
		...
		$this->data['antiorder'] =$antiorder ;
		
		$this->data['sorts'][] = array(
			'text'  => $this->language->get('text_default'),
			'value' => 'p.sort_order',
			'href'  => $this->url->link('product/featured', 'sort=p.sort_order' . $url),
		...
		$this->data['sorts'][] = array(
			...
			'value' => 'p.price',
			'href'  => $this->url->link('product/featured', 'sort=p.price&order='.$antiorder . $url),
		...
		foreach($limits as $limits){
			$this->data['limits'][] = array(
				'text'  => $limits,
				'value' => $limits,
				'href'  => $this->url->link('product/featured', $url . '&limit=' . $limits)
			);
		}
