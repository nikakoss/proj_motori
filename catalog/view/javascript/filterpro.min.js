...
var interval = 1;
var $cookie = false;
var container = ".folterprod";  /*  product-{view}*/
...
$(".textInputs").live("change", (function () {
...
function success(g, b) {
	...
	//alert(g.min_price);
	if(g.min_price>0 && g.max_price>0){
	
	$('.valueMin').text(g.min_price);
    $('.valueMax').text(g.max_price);
	}
    if (b) {
...
$(document).ready(function () {
	...
	$(".pagi ul li a").live("click", (function () {
...
$("#filterpro_sort").val($(this).attr("href"));
$("#filterpro_order").val($(this).attr("ord"));
iF();
if($(this).attr("href")=="p.price"){
if($(this).attr("ord")=="ASC"){

$(this).attr("ord","DESC");

$(this).removeClass("asc");
}  else if($(this).attr("ord")=="DESC"){
$(this).attr("ord","ASC");
$(this).addClass("asc");
		...
		return false;
	      ...
	      $(".sortmee").click(function () {
           wsort=$(this).attr('cods');
	         $("#filterpro_sort").val(wsort);
           $("#filterpro_order").val('ASC');
		   iF()
       $(".sortmee").css("color","yellow");
		sss=$("#filterpro_sort").val().split(".");
		$(".sortmee#"+sss[1]).css("color","red");
	 });
