...
<div class="simple-content">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="simpleregister">
                    ...
                    <?php if ($simple_registration_subscribe == 2) { ?>
                        <tr>
						  ...
						  <?php echo $entry_newsletter; ?>
							<input type="radio" id="subscryes" name="subscribe" value="1" <?php if ($subscribe) { ?>checked="checked"<?php } ?> /><label for="subscryes" class="labelRadio"><?php echo $text_yes; ?></label>
                           <input type="radio" id="subscrnot" name="subscribe" value="0" <?php if (!$subscribe) { ?>checked="checked"<?php } ?> /><label for="subscrnot" class="labelRadio"><?php echo $text_no; ?></label>
                          </td>
                        </tr>
                    <?php } ?>
		...
		<div class="simpleregister-button-block buttons noright">
