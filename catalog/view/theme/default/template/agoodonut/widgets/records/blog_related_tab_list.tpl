<?php if ($records) { ?>
<div id="related_<?php echo $prefix;?>">
<div id="tab-articles-<?php echo $prefix; ?>" class="tab-content">
...
$(document).ready(function(){
	<?php echo $parts_anchor[0]; ?>('<a href="#tab-articles-<?php echo $prefix; ?>"><?php echo $heading_title; ?> (<?php echo count($records); ?>)</a>');

	var related<?php echo $prefix; ?> = $('#related_<?php echo $prefix;?>').html();
	<?php echo $parts_anchor[1]; ?>(related<?php echo $prefix; ?> );
	$('#related_<?php echo $prefix;?>').hide('slow').remove();
