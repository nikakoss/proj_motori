...
<div class="commentAuthoranddate"><?php  echo $comment['author']; ?>| <?php echo $comment['date_added']; ?></div>
...
<div class="pagination mborder"><?php echo $pagination; ?></div>
