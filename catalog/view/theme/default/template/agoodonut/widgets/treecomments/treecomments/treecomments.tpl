...
<?php  } ?>
   ...
   <?php  if (isset($settings_widget['comment_must']) && $settings_widget['comment_must'])   {   ?>
	...
	<textarea name="text" id="<?php echo $prefix;?>editor_" class="blog-record-textarea <?php echo $prefix;?>editor blog-textarea_height" cols="40" rows="10"></textarea>
...
<?php if (isset($settings_widget['rating']) && $settings_widget['rating']) { ?>
     <b>kkkkkkk<ins class="color_entry_name"><?php echo $this->language->get('entry_rating_review'); ?></ins></b>&nbsp;&nbsp;
...
<div style="height: 25px;">
   ...
   <div class="floatleft"  style="padding-top: 5px; "><b>kkkkkkk<ins class="color_entry_name marginleft10"><span id="hover-test" ></span></ins></b></div>
...
<?php } ?>
 ...
 <?php } else {?>
  ...
  <div class="bordernone overflowhidden margintop5 lineheight1"></div>
    ...
    <?php  } ?>
  <a class="submit button-comment" id="<?php echo $prefix;?>button-comment-0"><span class="blofsend">отправить</span></a>
