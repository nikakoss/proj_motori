...
?>
 <b>
 <ins class="color_entry_name">
 <?php echo $field['field_description'][$this->config->get('config_language_id')]; ?>
 </ins>
 </b><br>
...
?>
<input type="text" name="af[<?php echo $field['field_name']; ?>]" style="width: 80%;" class="blog-record">
<?php
}
?>
