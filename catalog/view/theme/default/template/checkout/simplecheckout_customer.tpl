<div class="simplecheckout-block-heading">
    ...
    <span class="simplecheckout-block-heading-button">
		<a data-reveal-id="SignUpModal" data-animation="fadeAndPop" href="<?php echo $default_login_link ?>" <?php if (!$is_mobile) { ?><?php } ?> id="simplecheckout_customer_login"><?php echo $text_checkout_customer_login ?></a>
    </span>
    <?php } ?>
</div>  
