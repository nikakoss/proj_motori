    ...
    <div class="blockMain">
        ...
        <div class="blockMainTitle clearfix product-filter">
            ...
            <ul class="blockSorting"> <li>сортировать по:</li>
                ...
                <?php if ($sortss['value'] == "ps.price") { ?>
                <li><a class="sorter arrowso<?php if($order!="ASC"){ ?> asc<?php } ?>"  href="<?php echo $sortss['href']; ?>"><?php echo $sortss['text']; ?></a></li>
                <?php } else { ?>
                <li><a class="sorter" ord="ASC" id="priceso" href="<?php echo $sortss['href']; ?>"><?php echo $sortss['text']; ?></a></li>
                <?php } ?>
                <?php } ?>
            </ul>
        </div>
